...
const Header = () => {
  return (
    <header className="bg-white px-6 py-2 flex items-center justify-between">
      <div className="flex items-center justify-center gap-x-3.5">
        ...
        <div className="flex items-center justify-center gap-x-2.5">
          ...
          <p className="text-sm text-[#9CA3AF] font-medium">
            ...
            <span className="text-[#374151] text-sm font-medium">/</span>{" "}
      ...
      <div className="flex items-center justify-center gap-x-2.5">
        <TbCloudCheck className="w-4 h-4 text-[#6B7280]" />
        <div className="px-3 py-1.5 flex justify-center items-center gap-x-3 bg-[#EDF3EC] rounded-lg">
          <div className="flex items-center justify-center gap-x-1.5 text-[#438361]">
            <PiCoinsDuotone className="w-5 h-5" />
            <span className="text-xs font-medium">500/500</span>
          </div>
          <div className="flex items-center justify-center gap-x-1.5 h-6 px-2 bg-[#438361] rounded-lg">
